...
namespace Core.Models
{
    ...
    {
        public static string Header = $"{"Movie Title",-30}{"Cinema",-15}{"Screening Type",-15}{"Date and Time",-25}";
        ...
        {
            return $"{Movie.Title,-30}{Cinema.Name,-15}{ScreeningType,-15}{ScreeningDateTime,-25}";
        }
    }
}